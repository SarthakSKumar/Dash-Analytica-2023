...
function DashboardCard01(props) {
  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-slate-200 h-fill">
      <img src={props.src} className="h-inherit bg-cover" />
      {!props.src && (
